<<<<<<< HEAD
# Ticket model has been moved to tickets/models.py
# UploadedFile model has been moved to knowledge_base/models.py
# This file is now intentionally left blank for future support-specific models.
=======
